      ...
      <div className="max-w-[1100px] mx-auto px-4">
        <div className="booking-bar__inner">
          ...
          <div className="booking-bar__field" ref={checkinRef}>
            ...
            {openPanel === "checkin" && (
              <div className="booking-bar__dropdown booking-bar__dropdown--calendar">
                <MiniCalendar
                  value={checkin}
                  minDate={today}
                  locale={locale}
          ...
          <div className="booking-bar__field" ref={guestsRef}>
            ...
            {openPanel === "guests" && (
              <div className="booking-bar__dropdown booking-bar__dropdown--guests" onClick={e => e.stopPropagation()}>
                {rooms.map((room, i) => (
          ...
          <div className="booking-bar__field" ref={rateRef}>
            ...
            {openPanel === "rate" && (
              <div className="booking-bar__dropdown" onClick={e => e.stopPropagation()}>
